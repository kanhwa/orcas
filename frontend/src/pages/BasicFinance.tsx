...
export default function BasicFinance({ user }: BasicFinanceProps) {
  ...
  const [chatLanguage, setChatLanguage] = useState<'English' | 'Indonesia' | null>(null);
    ...
    <div className="space-y-6 relative pb-20">
      ...
      <div className="flex flex-col gap-2">
        <div className="relative">
          ...
          {inputValue.trim() === "" && (
            <div 
              className="absolute inset-y-0 left-[340px] right-12 flex items-center pointer-events-none overflow-hidden rounded-r-full"
              style={{ WebkitMaskImage: "linear-gradient(to right, transparent 0%, black 5%, black 100%)", maskImage: "linear-gradient(to right, transparent 0%, black 5%, black 100%)" }}
            >
              <div className="animate-farm-walk text-xl whitespace-nowrap opacity-60">
                <span>🦍 🐘 🦏 🦛 🐪 🐫 🦒 🦘 🐃 🐂 🐄 🐎 🐖 🐏 🐑 🦙 🐐 🦌 🐕 🐩 🐈 🐓 🦃 🦚 🦜 🦢 🦩 🐇 🦝 🦨 🦡 🦦 🦥 🐁 🐀 🐿 🦔 🐅 🐆 🦓 🐊 🐢 🦎 🐍 🦕 🦖 🐋 🐬 🐟 🐠 🐡 🦈 🐙 🦑 🦐 🦞 🦀 🐌 🦋 🐛 🐜 🐝 🐞 🕷 🦂 &nbsp; </span>
                <span>🦍 🐘 🦏 🦛 🐪 🐫 🦒 🦘 🐃 🐂 🐄 🐎 🐖 🐏 🐑 🦙 🐐 🦌 🐕 🐩 🐈 🐓 🦃 🦚 🦜 🦢 🦩 🐇 🦝 🦨 🦡 🦦 🦥 🐁 🐀 🐿 🦔 🐅 🐆 🦓 🐊 🐢 🦎 🐍 🦕 🦖 🐋 🐬 🐟 🐠 🐡 🦈 🐙 🦑 🦐 🦞 🦀 🐌 🦋 🐛 🐜 🐝 🐞 🕷 🦂 &nbsp; </span>
              </div>
            </div>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        {isChatOpen ? (
          <div className="w-[600px] h-[700px] bg-white border border-[rgb(var(--color-primary))]/50 rounded-lg shadow-xl flex flex-col overflow-hidden mb-3 animate-in fade-in slide-in-from-bottom-5 max-w-[90vw] max-h-[85vh]">
            ...
            {/* Chat Body */}
            <div className="flex-1 overflow-y-auto p-4 bg-gray-50 flex flex-col gap-4 text-base">
              {!chatLanguage ? (
